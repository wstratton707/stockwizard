...
with tab1:
    ...
    <div class="founder-card" style="display:flex;align-items:flex-start;gap:1.25rem">
        <img src="https://github.com/wstratton707/stockwizard/blob/main/assets/IMG_0434.jpeg"
...
with fc2:
    st.markdown("""
    <div class="founder-card" style="display:flex;align-items:flex-start;gap:1.25rem">
        <img src="https://github.com/wstratton707/stockwizard/blob/main/assets/IMG_0433.jpeg"
             style="width:72px;height:72px;border-radius:50%;object-fit:cover;
                    flex-shrink:0;border:2px solid #e2e8f0;margin-top:4px">
        <div>
            <div class="founder-quote">
        ...
        if live:
            ...
            <div class="live-ticker">
                ...
                <div style="text-align:right">
                    ...
                    <div style="color:#475569;font-size:0.75rem;margin-top:4px">Updated {live['time']}</div>
                ...
                try:
                    ...
                    if len(closes) >= 14:
                        ...
                        with r2:
                            ...
                            hist_colors = ["#22c55e" if v >= 0 else "#ef4444" for v in intraday_df["MACD_Hist"]]
